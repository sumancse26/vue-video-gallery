<script setup>
	defineProps({
		singleVideoHandler: Function
	});
</script>
<template>
	<div class="col-span-12 sm:col-span-6 md:col-span-3 duration-300 hover:scale-[1.03]">
		<div class="w-full flex flex-col" @click="singleVideoHandler('player')">
			<div class="relative">
				<a>
					<img
			...
			<div class="flex flex-row mt-2 gap-2">
				<a class="shrink-0">
					<img src="../assets/author.png" class="rounded-full h-6 w-6" alt="Learn with Sumit" />
				</a>
				...
				<div class="flex flex-col">
					...
					<a class="text-gray-400 text-xs mt-2 hover:text-gray-600" href="#"> Learn with Sumit </a>
